...
Open and view the Project using the `.zip` file provided or at my [Github Repository](https://github.com/manojkumar033/blog_site).

The project is also hosted on [Github](https://manojkumar033.github.io/blog_site/).
